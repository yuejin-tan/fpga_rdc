...
PERIPHERAL/Sources/%.o: ../PERIPHERAL/Sources/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -O3 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -I"D:\fpga\proj\mcu_project\cm3_led\CORE" -I"D:\fpga\proj\mcu_project\cm3_led\PERIPHERAL\Includes" -I"D:\fpga\proj\mcu_project\cm3_led\SYSTEM" -I"D:\fpga\proj\mcu_project\cm3_led\USER" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
